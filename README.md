...
- chat
- control the stream (both OBS and Chzzk Dashboard)
- login and logout

## Note
1. This README could be changed or stale in the near future. 
2. Korean Document will be written when 0.1.0 is released. 